...
export function PlantSelect() {
   ...
   //Carregamento Dinâmico, conforme for descendo o scroll 
   //mais itens serão carregados na página
   ...
   //Navegação(Passando os dados para a próxima página)
   function handlePlantsSelected(plant: PlantsProps) {
         ...
         <View style={styles.plants}>
            <FlatList 
               ...
               renderItem={({ item }) => (
                  <PlantCardPrimary 
                     data={item} 
                     onPress={() => handlePlantsSelected(item)}   
                  />                  
               )}
